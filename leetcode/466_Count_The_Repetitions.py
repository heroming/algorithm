...
if __name__ == "__main__" :
    so = Solution()
    print so.getMaxRepetitions('acb', 4, 'ab', 2)
    print so.getMaxRepetitions('acadsfadsfadsfadsfqweqrfdsawerweafewrafb', 400000, 'afadsafwerqrwqdsb', 201)
