...
class Solution(object) :
    def numberOfArithmeticSlices(self, v) :
        n = len(v)
        if n < 3 : return 0
...
if __name__ == "__main__" :
    ...
    print so.numberOfArithmeticSlices([8, 9, 4, 6, 6, 4, 9, 9, 0, 4, 10, 10])
    print so.numberOfArithmeticSlices([6, 8, 0, 8, 2, 4, 3, 5, 5, 8, 1, 0, 5, 3, 2, 1, 3, 8, 7, 3])
