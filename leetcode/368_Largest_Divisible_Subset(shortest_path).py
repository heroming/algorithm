...
class Solution(object) :
    def largestDivisibleSubset(self, nums) :
        ...
        for i in xrange(n) :
            maps[n].append((i, 1))
        dis = [0 for i in xrange(n + 1)]
        path = [n for i in xrange(n + 1)]
...
if __name__ == "__main__" :
    ...
    print so.largestDivisibleSubset([1, 2, 4, 8, 12])
    print so.largestDivisibleSubset([1, 2, 2, 2, 3, 3, 3, 9])
