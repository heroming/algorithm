...
class Solution(object) :
    def removeKdigits(self, s, m) :
            ...
            for k in xrange(10) :
                ...
                while l <= r :
                    ...
                    if pos[k][mi] < x :
                        ...
                        r = mi - 1
                if l < len(pos[k]) and pos[k][l] <= y : return pos[k][l]
            return -1
        ...
        for i in xrange(n) :
            pos[ord(s[i]) - zero].append(i)
        ans, idx = [], 0
        while m > 0 and idx + m < n :
            k = find(idx, idx + m)
            m -= k - idx
            ans.append(s[k])
            idx = k + 1
        ...
        ret = ''.join(ans)
        idx, n = 0, len(ret)
        while idx < n and ret[idx] == '0' : idx += 1
        if idx == n : return '0'
        return ret[idx:]
 
if __name__ == "__main__" :
    so = Solution()
    #print so.removeKdigits('1432219', 3)
    #print so.removeKdigits('10200', 1)
    print so.removeKdigits('123456789', 5)
