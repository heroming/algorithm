...
if __name__ == "__main__" :
    ...
    print so.exclusiveTime(2, ["0:start:0", "0:end:2", "1:start:3", "1:end:6"])
    print so.exclusiveTime(2, ["0:start:0","0:start:2","0:end:5","1:start:6","1:end:6","0:end:7"])
    print so.exclusiveTime(1, ["0:start:0","0:start:1","0:start:2","0:end:3","0:end:4","0:end:5"])
