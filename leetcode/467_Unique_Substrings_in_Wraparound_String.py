...
class Solution(object) :
    def findSubstringInWraproundString(self, s) :
        ...
        idx = 0
        n, letter = len(s), 26
        dic = [[] for i in xrange(letter)]
        valid = [1, ord('a') - ord('z')]
        for k in xrange(n) :
            if k == 0 or ord(s[k]) - ord(s[k - 1]) not in valid :
                idx = k
                add(s[idx], 1)
            else :
                m = min(k + 1, idx + letter)
...
if __name__ == "__main__" :
    ...
    print so.findSubstringInWraproundString("")
