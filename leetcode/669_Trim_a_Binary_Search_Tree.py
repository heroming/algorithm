        ...
        def trimBST(self, root, L, R) :
            ...
            def dfs(node, link) :
                ...
                if node.val < L :
                    ...
                    if link is None :
                        self.head = TreeNode(node.val)
                        dfs(node.left, self.head)
                        dfs(node.right, self.head)
                    else :
                        if node.val <= link.val :
                            link.left = TreeNode(node.val)
                            dfs(node.left, link.left)
                            dfs(node.right, link.left)
                        else :
                            link.right = TreeNode(node.val)
                            dfs(node.left, link.right)
                            dfs(node.right, link.right)
