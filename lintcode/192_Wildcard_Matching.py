...
class Solution :
    ...
    def isMatch(self, s, p) :
        ...
        n, m = len(s), len(p)
        dp = [[False for i in xrange(m + 1)] for j in xrange(n + 1)]
        dp[0][0] = True
        if n == 0 :
            return p.count("*") == m
        for i in xrange(n) :
...
if __name__ == "__main__" :
    ...
    print so.isMatch("a", "a**********")
    print so.isMatch("adfaksjdfoiwedskdfasdfasfdsfsafjasdjfhhasdkfjdskfjskadlfjsdkljsdbcfasgweasvaerrcvabudnymioimnbbrvcexxxwcrccaacracaecaeaevcreesd", "adf*??fja*ds*sk*k*j*b**c*cv*io*xx*c*c*c*c*a*e")
    print so.isMatch("abbabaaabbabbaababbabbbbbabbbabbbabaaaaababababbbabababaabbababaabbbbbbaaaabababbbaabbbbaabbbbababababbaabbaababaabbbababababbbbaaabbbbbabaaaabbababbbbaababaabbababbbbbababbbabaaaaaaaabbbbbaabaaababaaaabb", "**aa*****ba*a*bb**aa*ab****a*aaaaaa***a*aaaa**bbabb*b*b**aaaaaaaaa*a********ba*bbb***a*ba*bb*bb**a*b*bb")
