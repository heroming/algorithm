...
if __name__ == "__main__" :
    ...
    so = Solution()
    print so.permutationIndex([1, 2, 4])
    print so.permutationIndex([3, 6, 1, 8, 2, 5, 9, 7, 4])
    print so.permutationIndex([3, 6, 1, 8, 2, 5, 9, 7, 4, 0])
